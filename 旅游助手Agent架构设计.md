...
> v0.6.0 | 2026-08-04 | FastAPI + Next.js 前后端分离 | DeepSeek 驱动
...
项目定位：**展示 Agentic AI 工程能力的全栈项目**——自定义 Agent 循环、工具编排系统、中间件管道、记忆管理（v0.6.0 规则提取）、多 Agent 协作（规划中）。
